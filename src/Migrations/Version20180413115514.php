 ...
 */
class Version20180413115514 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE trip (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, length INT NOT NULL, duration INT NOT NULL, cost INT NOT NULL, INDEX IDX_7656F53B19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
